  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-WhiteBg py-10 text-center text-black md:max-w-[80%] mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 border border-gray-200 rounded-[12px] shadow-md">
          <div className="p-6 md:p-8 lg:p-10 flex flex-col justify-start items-start gap-10 space-y-3">
